...
export default async function OrdersPage() {
  ...
  if (!userId) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-black px-4">
        <div className="bg-white shadow-xl rounded-3xl p-10 text-center max-w-md w-full border border-gray-100 dark:bg-gray-900">
          ...
          <Link href="/login">
            <button className="mt-6 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-xl font-semibold transition"> Login </button>
          </Link>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-black px-4">
        <div className="bg-white shadow-xl rounded-3xl p-10 text-center max-w-md w-full border border-gray-100 dark:bg-gray-900 dark:border-gray-700">
          ...
          <Link href="/products">
            <button className="mt-6 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-xl font-semibold transition"> Shop Now </button>
          </Link>
        </div>
      </div>
    );
        ...
        <div className="space-y-5">
          {orders.map((order) => {
            ...
            return (
              ...
              >
                <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 cursor-pointer hover:-translate-y-1">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-green-700 dark:text-green-300"> ₹{order.amount} </p>
                    </div>
                    <div className="text-green-700 font-semibold text-sm dark:text-green-300"> View Details → </div>
                  </div>
                </div>
              </Link>
            );
