    ...
    <div className="p-10 max-w-5xl mx-auto dark:text-white text-black">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <Link
          ...
          className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-10 rounded-lg shadow hover:shadow-lg transition text-center"
        >
